  ...
  return (
    <main className="py-20">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-5xl font-bold text-primary-700 mb-8">About Business e2e-stage-1768137346</h1>

        <div className="prose prose-lg">
          <p className="text-xl text-gray-700 mb-6">
            With over two decades of experience in business-e2e-stage-1768137346, we've built our reputation on
          ...
          <p className="text-gray-700">
            To provide our clients with trusted, reliable business-e2e-stage-1768137346 services that exceed expectations
          ...
          <div className="bg-primary-50 p-8 rounded-lg mt-12">
            ...
            <p className="text-gray-700">
              Ready to work with a trusted business-e2e-stage-1768137346 partner? Contact us today to discuss your needs.
            </p>
